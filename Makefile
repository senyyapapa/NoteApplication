#############################################################################
# Makefile for building: Note.app/Contents/MacOS/Note
# Generated by qmake (3.1) (Qt 6.9.0)
# Project:  Note.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile Note.pro
#############################################################################
...
DEFINES       = -DQT_NO_DEBUG -DQT_UITOOLS_LIB -DQT_OPENGLWIDGETS_LIB -DQT_WIDGETS_LIB -DQT_OPENGL_LIB -DQT_GUI_LIB -DQT_CORE_LIB
...
INCPATH       = -I. -I/usr/local/lib/QtUiTools.framework/Headers -I/usr/local/lib/QtOpenGLWidgets.framework/Headers -I/usr/local/lib/QtWidgets.framework/Headers -I/usr/local/lib/QtOpenGL.framework/Headers -I/usr/local/lib/QtGui.framework/Headers -I/usr/local/lib/QtCore.framework/Headers -I. -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/AGL.framework/Headers -I. -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/AGL.framework/Headers -I/usr/local/share/qt/mkspecs/macx-clang -F/usr/local/lib
...
COMPRESS      = gzip -9f
DISTNAME      = Note1.0.0
DISTDIR = /Users/senyapapa/Projects/Note/.tmp/Note1.0.0
...
LIBS          = $(SUBLIBS) -F/usr/local/lib -framework QtUiTools -framework QtOpenGLWidgets -framework QtWidgets -framework QtOpenGL -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtCore -framework IOKit -framework DiskArbitration -framework UniformTypeIdentifiers -framework AGL -framework OpenGL   
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		readfile.cpp \
		updatetable.cpp qrc_resources.cpp \
		moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		readfile.o \
...
DIST          = data.txt \
		...
		/usr/local/Cellar/qt/6.9.0/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.9.0/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.9.0/share/qt/mkspecs/common/macx.conf \
		/usr/local/Cellar/qt/6.9.0/share/qt/mkspecs/common/sanitize.conf \
		/usr/local/Cellar/qt/6.9.0/share/qt/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/6.9.0/share/qt/mkspecs/common/gcc-base-mac.conf \
		/usr/local/Cellar/qt/6.9.0/share/qt/mkspecs/common/clang.conf \
		/usr/local/Cellar/qt/6.9.0/share/qt/mkspecs/common/clang-mac.conf \
		...
		Note.pro mainwindow.h \
		note.h \
		readfile.h \
		updatetable.h main.cpp \
		mainwindow.cpp \
		readfile.cpp \
		updatetable.cpp
QMAKE_TARGET  = Note
DESTDIR       = 
TARGET        = Note.app/Contents/MacOS/Note
...
EXPORT__PRO_FILE_ = /Users/senyapapa/Projects/Note/Note.pro


include /usr/local/Cellar/qt/6.9.0/share/qt/mkspecs/features/mac/sdk.mk
first: all
####### Build rules

Note.app/Contents/MacOS/Note: ui_mainwindow.h $(OBJECTS)  
	@test -d Note.app/Contents/MacOS/ || mkdir -p Note.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Note.pro /usr/local/share/qt/mkspecs/macx-clang/qmake.conf /usr/local/share/qt/mkspecs/features/spec_pre.prf \
		/usr/local/share/qt/mkspecs/features/device_config.prf \
		/usr/local/Cellar/qt/6.9.0/share/qt/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/6.9.0/share/qt/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/6.9.0/share/qt/mkspecs/common/macx.conf \
		...
		Note.pro \
		resources.qrc \
		/usr/local/lib/QtUiTools.framework/Resources/QtUiTools.prl \
...
Note.app/Contents/PkgInfo: 
	@test -d Note.app/Contents || mkdir -p Note.app/Contents
	@$(DEL_FILE) Note.app/Contents/PkgInfo
	@echo "APPL????" > Note.app/Contents/PkgInfo
Note.app/Contents/Info.plist: 
	@test -d Note.app/Contents || mkdir -p Note.app/Contents
	@$(DEL_FILE) Note.app/Contents/Info.plist
	@plutil -convert xml1 -o - /usr/local/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.Note,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.Note,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,Note,g" -e "s,@LIBRARY@,Note,g" -e "s,\$${EXECUTABLE_NAME},Note,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >Note.app/Contents/Info.plist

all: Makefile \
		Note.app/Contents/PkgInfo \
		Note.app/Contents/Info.plist Note.app/Contents/MacOS/Note
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h note.h readfile.h updatetable.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp readfile.cpp updatetable.cpp $(DISTDIR)/
...
moc_mainwindow.cpp: mainwindow.h \
	...
	/usr/local/share/qt/libexec/moc $(DEFINES) --include /Users/senyapapa/Projects/Note/moc_predefs.h -I/usr/local/share/qt/mkspecs/macx-clang -I/Users/senyapapa/Projects/Note -I/usr/local/lib/QtUiTools.framework/Headers -I/usr/local/lib/QtOpenGLWidgets.framework/Headers -I/usr/local/lib/QtWidgets.framework/Headers -I/usr/local/lib/QtOpenGL.framework/Headers -I/usr/local/lib/QtGui.framework/Headers -I/usr/local/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/17/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/usr/local/lib mainwindow.h -o moc_mainwindow.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/Note/bin || mkdir -p $(INSTALL_ROOT)/opt/Note/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/Note/bin/Note.app
	
	$(QINSTALL) Note.app $(INSTALL_ROOT)/opt/Note/bin/Note.app
	-$(STRIP) $(INSTALL_ROOT)/opt/Note/bin/Note.app/Contents/MacOS/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/Note/bin/Note.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/Note/bin/ 
